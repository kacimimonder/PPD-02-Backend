...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260428172132_AddLectureAttachments")]
    partial class AddLectureAttachments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AiGeneratedQuiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("GeneratedForEnrollmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GeneratedForEnrollmentId");

                    b.HasIndex("ModuleId");

                    b.ToTable("AiGeneratedQuizzes", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.LectureAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LectureAttachments", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.QuizAssignment", b =>
                {
                    ...
                    b.Property<int>("AiGeneratedQuizId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AssignedByInstructorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssignedByInstructorId");

                    b.HasIndex("EnrollmentId");

                    b.HasIndex("AiGeneratedQuizId", "EnrollmentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.StudentQuizAttempt", b =>
                {
                    ...
                    b.Property<string>("StudentResponses")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("AiGeneratedQuizId");

                    b.HasIndex("QuizAssignmentId");

                    b.HasIndex("EnrollmentId", "AiGeneratedQuizId", "CreatedAt");
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("AiAmbitions")
                        .HasMaxLength(1200)
                        .HasColumnType("nvarchar(1200)");

                    b.Property<string>("AiInterests")
                        .HasMaxLength(1200)
                        .HasColumnType("nvarchar(1200)");

                    b.Property<DateTime?>("AiProfileUpdatedAtUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Entities.AiGeneratedQuiz", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Enrollment", "GeneratedForEnrollment")
                        .WithMany()
                        .HasForeignKey("GeneratedForEnrollmentId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("GeneratedForEnrollment");
            ...
            modelBuilder.Entity("Domain.Entities.QuizAssignment", b =>
                {
                    b.HasOne("Domain.Entities.AiGeneratedQuiz", "AiGeneratedQuiz")
                        .WithMany("Assignments")
                        .HasForeignKey("AiGeneratedQuizId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.User", "AssignedByInstructor")
                        .WithMany()
                        .HasForeignKey("AssignedByInstructorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("AssignedByInstructor");
            ...
            modelBuilder.Entity("Domain.Entities.ModuleContent", b =>
                {
                    b.Navigation("LectureAttachments");
                });

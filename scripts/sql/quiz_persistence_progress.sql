...
IF DB_ID('MiniCourseraDB') IS NULL
BEGIN
...
BEGIN
    CREATE TABLE [dbo].[AiGeneratedQuizzes](
        ...
        CONSTRAINT [FK_AiGeneratedQuizzes_CourseModules_ModuleId] FOREIGN KEY([ModuleId])
            REFERENCES [dbo].[CourseModules]([Id]) ON DELETE CASCADE,
        CONSTRAINT [FK_AiGeneratedQuizzes_Enrollments_GeneratedForEnrollmentId] FOREIGN KEY([GeneratedForEnrollmentId])
            REFERENCES [dbo].[Enrollments]([Id]),
        CONSTRAINT [FK_AiGeneratedQuizzes_Users_GeneratedByUserId] FOREIGN KEY([GeneratedByUserId])
...
BEGIN
    CREATE TABLE [dbo].[QuizAssignments](
        ...
        CONSTRAINT [FK_QuizAssignments_AiGeneratedQuizzes_AiGeneratedQuizId] FOREIGN KEY([AiGeneratedQuizId])
            REFERENCES [dbo].[AiGeneratedQuizzes]([Id]) ON DELETE CASCADE,
        CONSTRAINT [FK_QuizAssignments_Enrollments_EnrollmentId] FOREIGN KEY([EnrollmentId])
            REFERENCES [dbo].[Enrollments]([Id]),
        CONSTRAINT [FK_QuizAssignments_Users_AssignedByInstructorId] FOREIGN KEY([AssignedByInstructorId])
            REFERENCES [dbo].[Users]([Id])
    );
END
GO
...
BEGIN
    CREATE TABLE [dbo].[StudentQuizAttempts](
        ...
        CONSTRAINT [FK_StudentQuizAttempts_AiGeneratedQuizzes_AiGeneratedQuizId] FOREIGN KEY([AiGeneratedQuizId])
            REFERENCES [dbo].[AiGeneratedQuizzes]([Id]) ON DELETE CASCADE,
        CONSTRAINT [FK_StudentQuizAttempts_Enrollments_EnrollmentId] FOREIGN KEY([EnrollmentId])
            REFERENCES [dbo].[Enrollments]([Id]),
        CONSTRAINT [FK_StudentQuizAttempts_QuizAssignments_QuizAssignmentId] FOREIGN KEY([QuizAssignmentId])
            REFERENCES [dbo].[QuizAssignments]([Id]) ON DELETE SET NULL
    );
END
GO
